...
async function loadAvailableSlots() {
    ...
    try {
        const response = await fetch(
            `https://sliuba-production.up.railway.app/api/slots?date=${dateForApi}&duration=${selectedDuration}`
        );
...
if (bookingForm && successMessage) {
    bookingForm.addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch("https://sliuba-production.up.railway.app/api/appointments", {
                method: "POST",
                headers: {
